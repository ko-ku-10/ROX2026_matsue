...
WHEEL_COMMAND_SLEW_RATE = 1.5       # ホイール指令の急変を抑える
...
IDLE_HOLD_DAMPING_KP = 0.24      # 中立保持の速度制動
IDLE_HOLD_OUTPUT_LIMIT = 0.18    # 中立保持の最大出力
IDLE_HOLD_MAX_SPEED = 1.00       # 押されても速度を丸めて制動を続ける
IDLE_HOLD_RELEASE_SEC = 0.2      # 操作後すぐは短時間だけ保持を休ませる
